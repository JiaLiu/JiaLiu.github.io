...
|QUnit||
|----|----|
|网站|[qunitjs.com/](https://qunitjs.com/)|
...
与库和框架相比，工具的选择就显得不是那么关键了，不同的项目可能会有很多不同的选择。大多数人在使用 [Gulp](http://gulpjs.com/)，但越来越多的人开始喜欢 [Webpack](https://webpack.js.org/)。有 [ESLint](http://eslint.org/) 做代码检查，再加上 [Mocha](https://mochajs.org/) 进行测试，你不再会写出错误的代码。当然，它们也都有很多可替代的选择。
...
我遗漏了你喜欢的 JavaScript 库、框架或者工具了吗？我想这是肯定的！那么就请在[这里](https://www.sitepoint.com/top-javascript-frameworks-libraries-tools-use/#comments)给出你的评论吧。
